...
<div class="container">
    ...
    <form method="post" action="update_profile.php">
        ...
        <label for="languages">Любимые языки программирования (через запятую):</label>
        ...
        <label for="contract_accepted">Контракт:</label>
        <input type="checkbox" id="contract_accepted" name="contract_accepted" <?= $user['contract_accepted'] ? 'checked' : '' ?> disabled>
        <small>Вы не можете изменить статус контракта.</small>
